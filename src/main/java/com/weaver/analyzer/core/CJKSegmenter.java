 ...
 * 
 */
package com.weaver.analyzer.core;


import com.weaver.analyzer.dic.Dictionary;
import com.weaver.analyzer.dic.Hit;
...
class CJKSegmenter implements ISegmenter {
  ...
  /*
   * (non-Javadoc)
   * @see ISegmenter#analyze(AnalyzeContext)
   */
