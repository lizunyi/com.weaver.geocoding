 ...
 * 
 */
package com.weaver.analyzer.query;
...
public class IKQueryExpressionParser {
  ...
  private TermRangeQuery toTermRangeQuery(Element fieldNameEle, LinkedList<Element> elements) {
    ...
    return new TermRangeQuery(fieldNameEle.toString(), new BytesRef(firstValue), new BytesRef(
        lastValue), includeFirst, includeLast);
  }
